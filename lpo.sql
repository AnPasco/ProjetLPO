...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 19 fév. 2019 à 12:35
...
CREATE TABLE IF NOT EXISTS `calendrier` (
  ...
  `id_lieurdv` int(11) NOT NULL,
  `h_rdv` time NOT NULL,
  `id_org` int(11) NOT NULL,
  `id_inter1` int(11) NOT NULL,
  `id_inter2` int(11) DEFAULT NULL,
  `id_cond` int(11) NOT NULL,
  `inscription` int(11) NOT NULL,
  `id_cptr` int(11) DEFAULT NULL,
  `en_att` tinyint(1) DEFAULT '0',
  `accepte` tinyint(1) DEFAULT '1',
  `code_user` int(11) NOT NULL,
  PRIMARY KEY (`id_evt`),
  KEY `id_duree` (`id_duree`),
  KEY `id_theme` (`id_theme`),
  KEY `id_dpt` (`id_dpt`),
  KEY `id_lieurdv` (`id_lieurdv`),
  KEY `id_org` (`id_org`),
  KEY `id_inter1` (`id_inter1`),
  KEY `id_inter2` (`id_inter2`),
  KEY `id_cond` (`id_cond`),
...
INSERT INTO `carre` (`carre_num`, `en_num`, `carre_nom`, `enqueteur`, `etat`) VALUES
(1, 1, 'carre_0-6', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `compterendu` (
  `id_cptr` int(11) NOT NULL AUTO_INCREMENT,
  `id_inter` int(11) NOT NULL,
  `nb_particip` int(11) DEFAULT NULL,
  `lib_cptr` varchar(255) DEFAULT NULL,
...
INSERT INTO `conditions` (`id_cond`, `lib_cond`) VALUES
(1, 'Libre'),
(2, 'Payant'),
(3, 'Se renseigner aupres de l\'intervenant');
...
CREATE TABLE IF NOT EXISTS `departement` (
  ...
  `num_dpt` int(11) NOT NULL,
  `lib_dpt` varchar(255) NOT NULL,
  `reg_anc` varchar(255) NOT NULL,
  `reg_nouv` varchar(255) NOT NULL,
  PRIMARY KEY (`id_dpt`)
...
INSERT INTO `departement` (`id_dpt`, `num_dpt`, `lib_dpt`, `reg_anc`, `reg_nouv`) VALUES
(1, 19, 'Correze', 'Limousin', 'Nouvelle Aquitaine'),
(2, 23, 'Creuse', 'Limousin', 'Nouvelle Aquitaine'),
(5, 24, 'Dordogne', 'Aquitaine', 'Nouvelle Aquitaine'),
(6, 87, 'Haute-Vienne', 'Limousin', 'Nouvelle Aquitaine');
...
CREATE TABLE IF NOT EXISTS `duree` (
  ...
  `lib_duree` varchar(255) NOT NULL,
...
INSERT INTO `duree` (`id_duree`, `lib_duree`) VALUES
(1, 'Matin'),
(2, 'Apres Midi'),
(3, 'Soiree'),
(4, 'Journee'),
...
CREATE TABLE IF NOT EXISTS `intervenant` (
  ...
  `email_inter` varchar(255) DEFAULT NULL,
  `tel_inter` varchar(255) DEFAULT NULL,
...
('carre_1-9', 'E060N658'),
('carre_0-9', 'E060N659'),
('carre_17-10', 'E061N642'),
('carre_16-10', 'E061N643'),
('carre_15-10', 'E061N644'),
('carre_14-10', 'E061N645'),
('carre_13-10', 'E061N646'),
('carre_12-10', 'E061N647'),
('carre_11-10', 'E061N648'),
('carre_10-10', 'E061N649'),
('carre_9-10', 'E061N650'),
('carre_8-10', 'E061N651'),
('carre_7-10', 'E061N652'),
('carre_6-10', 'E061N653'),
...
('carre_1-10', 'E061N658'),
('carre_0-10', 'E061N659'),
('carre_16-11', 'E062N643'),
('carre_15-11', 'E062N644'),
('carre_14-11', 'E062N645'),
('carre_13-11', 'E062N646'),
('carre_12-11', 'E062N647'),
('carre_11-11', 'E062N648'),
('carre_10-11', 'E062N649'),
('carre_9-11', 'E062N650'),
('carre_8-11', 'E062N651'),
('carre_7-11', 'E062N652'),
('carre_6-11', 'E062N653'),
...
('carre_1-11', 'E062N658'),
('carre_0-11', 'E062N659'),
('carre_16-12', 'E063N643'),
('carre_15-12', 'E063N644'),
('carre_14-12', 'E063N645'),
('carre_13-12', 'E063N646'),
('carre_12-12', 'E063N647'),
('carre_11-12', 'E063N648'),
('carre_10-12', 'E063N649'),
('carre_9-12', 'E063N650'),
('carre_8-12', 'E063N651'),
('carre_7-12', 'E063N652'),
('carre_6-12', 'E063N653'),
...
('carre_1-12', 'E063N658'),
('carre_0-12', 'E063N659'),
('carre_13-13', 'E064N646'),
('carre_12-13', 'E064N647'),
('carre_11-13', 'E064N648'),
('carre_10-13', 'E064N649'),
('carre_9-13', 'E064N650'),
('carre_8-13', 'E064N651'),
('carre_7-13', 'E064N652'),
('carre_6-13', 'E064N653'),
...
('carre_1-13', 'E064N658'),
('carre_0-13', 'E064N659'),
('carre_12-14', 'E065N647'),
('carre_11-14', 'E065N648'),
('carre_10-14', 'E065N649'),
('carre_9-14', 'E065N650'),
('carre_8-14', 'E065N651'),
('carre_7-14', 'E065N652'),
('carre_6-14', 'E065N653'),
...
('carre_2-14', 'E065N657'),
('carre_1-14', 'E065N658'),
('carre_12-15', 'E066N647'),
('carre_11-15', 'E066N648'),
('carre_10-15', 'E066N649'),
('carre_9-15', 'E066N650'),
('carre_8-15', 'E066N651'),
('carre_7-15', 'E066N652'),
('carre_6-15', 'E066N653'),
...
--
-- Structure de la table `lieurdv`
--

DROP TABLE IF EXISTS `lieurdv`;
CREATE TABLE IF NOT EXISTS `lieurdv` (
  `id_lieurdv` int(11) NOT NULL AUTO_INCREMENT,
  `lib_lieurdv` varchar(255) NOT NULL,
  PRIMARY KEY (`id_lieurdv`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `organisateur` (
  ...
  `lib_org` varchar(255) NOT NULL,
  `adr_1_org` varchar(255) DEFAULT NULL,
  `adr_2_org` varchar(255) DEFAULT NULL,
  `cp_ville_org` varchar(255) DEFAULT NULL,
  `tel_org` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_org`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `personne` (
  ...
  `per_nom` varchar(30) DEFAULT NULL,
  `per_fonction` varchar(30) DEFAULT NULL,
  `per_pre` varchar(30) DEFAULT NULL,
  `per_tel` int(11) DEFAULT NULL,
  `per_mail` varchar(50) DEFAULT NULL,
  `per_pwd` varchar(50) DEFAULT NULL,
  `per_login` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`per_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
INSERT INTO `personne` (`per_id`, `per_nom`, `per_fonction`, `per_pre`, `per_tel`, `per_mail`, `per_pwd`, `per_login`) VALUES
(1, 'SOLO', 'inscrit', 'Léa', 765986958, 'lea@etu.unilim.fr', 'lea', 'lea'),
(2, 'DEVAUX', 'administrateur', 'Audrey', 765986958, 'aud@etu.unilim.fr', 'aud', 'aud'),
(3, 'ANDRE', 'animateur', 'manon', 765986958, 'manon@etu.unilim.fr', 'manon', 'manon');
