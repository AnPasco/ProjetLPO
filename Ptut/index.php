...
<body>
  <div class="map" id="map">
      ...
      <image xlink:href="./Carte_Lim_mailles-page-001.svg" id="Carte_Limmailles" />
      ...
      <?php
         for($i = 0; $i<$length; $i++){
            ...
            for($colonne = $debut; $colonne <= $fin ; $colonne++){
               ?>
               <a id="carre<?php echo $i?>- <?php echo $colonne ?>" xlink:href="http://www.google.com/" xlink:title="carre_<?php echo $i?>-<?php echo $colonne ?>">
