...
require 'EnqueteManager.class.php';
require 'Adherent.class.php';
require 'AdherentManager.class.php';
require 'Carre.class.php';
require 'CarreManager.class.php';
require 'Carte.class.php';
require 'CarteManager.class.php';
require 'Enquete.class.php';
require 'KMZ.class.php';
require 'KMZManager.class.php';
require 'Oiseau.class.php';
require 'OiseauManager.class.php';
require 'Protocole.class.php';
require 'ProtocoleManager.class.php';
...
if (empty($_POST['text'])) {
    ...
    <?php } else {
        ...
        ?>
        <div class="map" id="map" style = "width : 60%">
    ...
    if ($enqueteur == null){
        ...
        <a href="PDF/<?php echo $protocole->getFichierProtocole() ?>.pdf" download>
            <img class="lien" src="images/telechargement.jpg" alt="Voici un lien de téléchargement du protocole">
        </a>
      </br>
        <a href="images/Cartes/Atlas dynamique/<?php echo $carte->getCarteImg() ?>.jpg" download>
            <img src="images/Cartes/Atlas dynamique/<?php echo $carte->getCarteImg() ?>.jpg" alt="Ceci est l'image de la carte à télécharger">
        </a>
        </br>

        <a href="images/KMZ/<?php echo $KMZ->getKMZFichier() ?>.KMZ" download>
            <img class="lien" src="images/telechargement.jpg" alt="Voici un fichier KMZ pour aider à vous géolocaliser. Vous pouvez l'utiliser sur google earth.">
        </a>
        </br>
    <?php }
} ?>
